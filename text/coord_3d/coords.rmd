...
<iframe width="560" height="315" src="https://www.youtube.com/embed/JsLqgb1E2c0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
```{r, echo=FALSE}
fname <- "../../asymptote/3dcoords/coordplanes.html"
copied <- file.copy(fname, ".", overwrite = TRUE)
htmltools::tags$iframe(title = "Three coordinate planes", src = basename(fname), width=285*2, height=256*2, frameborder="0")
```
...
```{r, echo=FALSE}
fname <- "../../asymptote/3dcoords/coordbox.html"
copied <- file.copy(fname, ".", overwrite = TRUE)
htmltools::tags$iframe(title = "Projections and coordinate box", src = basename(fname), width=285*2, height=256*2, frameborder="0")
```
...
```{r, echo=FALSE}
fname <- "../../asymptote/3dcoords/coordplanesbox.html"
copied <- file.copy(fname, ".", overwrite = TRUE)
htmltools::tags$iframe(title = "Coordinate box with coordinate planes", src = basename(fname), width=285*2, height=256*2, frameborder="0")
```
...
&answersSubmitted=0
&sourceFilePath=Library/272/setStewart12_1/problem_1.pg
&problemSeed=123
&displayMode=MathJax
...
$P$ to a plane or a line is a distance from $P$ to the point in the plane or
line that is __nearest__ to $P$.)

<iframe height="700" src="https://webwork.svsu.edu/webwork2/html2xml?
&answersSubmitted=0
&sourceFilePath=Library/UMN/calculusStewartET/s_12_1_10.pg
&problemSeed=123
&displayMode=MathJax
&courseID=daemon_course
&userID=daemon
