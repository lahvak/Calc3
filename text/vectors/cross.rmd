...
u_1}$ (You can also use $\v{u_2, -u+1}$, which would point in the opposite
...
The Lagrange property is a concequence of the Pythagorean identity for sine and
...
is the _signed volume_ of the parallelepiped determined by the vectors 
$\vec{a} = \v{a_1, a_2, a_3}$, 
